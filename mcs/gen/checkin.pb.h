...
namespace protobuf_checkin_2eproto {
...
void InitDefaultsGservicesSettingImpl();
void InitDefaultsGservicesSetting();
void InitDefaultsAndroidCheckinRequestImpl();
void InitDefaultsAndroidCheckinRequest();
void InitDefaultsAndroidCheckinResponseImpl();
void InitDefaultsAndroidCheckinResponse();
inline void InitDefaults() {
  InitDefaultsGservicesSetting();
  InitDefaultsAndroidCheckinRequest();
  InitDefaultsAndroidCheckinResponse();
}
}  // namespace protobuf_checkin_2eproto
...
class GservicesSetting : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:checkin_proto.GservicesSetting) */ {
 ...
 private:
  ...
  friend struct ::protobuf_checkin_2eproto::TableStruct;
  friend void ::protobuf_checkin_2eproto::InitDefaultsGservicesSettingImpl();
};
// -------------------------------------------------------------------
...
class AndroidCheckinRequest : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:checkin_proto.AndroidCheckinRequest) */ {
 ...
 private:
  ...
  friend struct ::protobuf_checkin_2eproto::TableStruct;
  friend void ::protobuf_checkin_2eproto::InitDefaultsAndroidCheckinRequestImpl();
};
// -------------------------------------------------------------------
...
class AndroidCheckinResponse : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:checkin_proto.AndroidCheckinResponse) */ {
 ...
 private:
  ...
  bool market_ok_;
  friend struct ::protobuf_checkin_2eproto::TableStruct;
  friend void ::protobuf_checkin_2eproto::InitDefaultsAndroidCheckinResponseImpl();
};
// ===================================================================
...
inline const ::checkin_proto::AndroidCheckinProto& AndroidCheckinRequest::checkin() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::checkin_proto::AndroidCheckinProto*>(
...
inline void AndroidCheckinRequest::set_allocated_checkin(::checkin_proto::AndroidCheckinProto* checkin) {
  ...
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(checkin_);
  }
  if (checkin) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      checkin = ::google::protobuf::internal::GetOwnedMessage(

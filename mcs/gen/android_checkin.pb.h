...
void protobuf_AssignDesc_android_5fcheckin_2eproto();
...
class ChromeBuildProto : public ::google::protobuf::MessageLite {
 public:
  ChromeBuildProto();
  ...
  inline ChromeBuildProto* New() const { return New(NULL); }

  ChromeBuildProto* New(::google::protobuf::Arena* arena) const;
  ...
  static const Platform PLATFORM_WIN = ChromeBuildProto_Platform_PLATFORM_WIN;
  static const Platform PLATFORM_MAC = ChromeBuildProto_Platform_PLATFORM_MAC;
  static const Platform PLATFORM_LINUX = ChromeBuildProto_Platform_PLATFORM_LINUX;
  static const Platform PLATFORM_CROS = ChromeBuildProto_Platform_PLATFORM_CROS;
  static const Platform PLATFORM_IOS = ChromeBuildProto_Platform_PLATFORM_IOS;
  static const Platform PLATFORM_ANDROID = ChromeBuildProto_Platform_PLATFORM_ANDROID;
  ...
  static const Channel CHANNEL_STABLE = ChromeBuildProto_Channel_CHANNEL_STABLE;
  static const Channel CHANNEL_BETA = ChromeBuildProto_Channel_CHANNEL_BETA;
  static const Channel CHANNEL_DEV = ChromeBuildProto_Channel_CHANNEL_DEV;
  static const Channel CHANNEL_CANARY = ChromeBuildProto_Channel_CHANNEL_CANARY;
  static const Channel CHANNEL_UNKNOWN = ChromeBuildProto_Channel_CHANNEL_UNKNOWN;
 ...
 private:
  ...
  int channel_;
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void  protobuf_AddDesc_android_5fcheckin_2eproto_impl();
  #else
  friend void  protobuf_AddDesc_android_5fcheckin_2eproto();
  #endif
  friend void protobuf_AssignDesc_android_5fcheckin_2eproto();
  friend void protobuf_ShutdownFile_android_5fcheckin_2eproto();

  void InitAsDefaultInstance();
  static ChromeBuildProto* default_instance_;
};
// -------------------------------------------------------------------

class AndroidCheckinProto : public ::google::protobuf::MessageLite {
 public:
  AndroidCheckinProto();
  ...
  inline AndroidCheckinProto* New() const { return New(NULL); }

  AndroidCheckinProto* New(::google::protobuf::Arena* arena) const;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from);
 ...
 private:
  inline void set_has_last_checkin_msec();
  inline void clear_has_last_checkin_msec();
  inline void set_has_cell_operator();
  inline void clear_has_cell_operator();
  inline void set_has_sim_operator();
  inline void clear_has_sim_operator();
  ...
  inline void set_has_chrome_build();
  inline void clear_has_chrome_build();
  ...
  void InitAsDefaultInstance();
  static AndroidCheckinProto* default_instance_;
};
// ===================================================================
...
inline const ::std::string& AndroidCheckinProto::cell_operator() const {
  ...
  return cell_operator_.GetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline const ::std::string& AndroidCheckinProto::sim_operator() const {
  ...
  return sim_operator_.GetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline const ::std::string& AndroidCheckinProto::roaming() const {
  ...
  return roaming_.GetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  return chrome_build_ != NULL ? *chrome_build_ : *default_instance().chrome_build_;
#else
  return chrome_build_ != NULL ? *chrome_build_ : *default_instance_->chrome_build_;
#endif
}
